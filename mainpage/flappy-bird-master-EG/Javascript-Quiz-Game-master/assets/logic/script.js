...
const questions = [
  { //1
    ...
    answers: [
      { text: "Egyptian god", correct: false },
      { text: "Picture writing", correct: true },
      { text: "Egyptain boats", correct: false },
      { text: "Jars for storing a mummy's intrenal organs", correct: false }
    ]
  },
  {//2
    question: "How many mummies did archaeologists find inside the Great Pyramid at Giza?",
    answers: [
  ...
  {//3
    ...
    answers: [
      { text: "99 millions", correct: true },
      { text: "12 millions", correct: false},
      { text: '50 millions', correct: false },
      { text: '112 millions', correct: false },
    ]
  },
  {//4
    question: 'Who is the Egyptian scientist who won the Nobel Prize in Chemistry?',
    answers: [
      { text: 'mohamed salah', correct: false },
      { text: 'farouk el baz', correct: false },
      { text: 'ahmed zewail', correct: true },
      { text: 'Adel Imam', correct: false }
    ]
  },
  {//5
    question: "Who was the president of Egypt in 1967?",
    answers: [
      { text: "anwar sadat ", correct: false },
      { text: "Hosni Moubarak", correct: false },
      { text: "Gamal Abdel Nasser", correct: true },
      { text: "abdel fattah al-sissi", correct: false }
    ]
  },

  {//6
    question: "Who is the funniest Egyptian actor?",
    answers: [
      { text: "Adel Imam", correct: true },
      { text: "Ahmed Helmy", correct: true },
      { text: "Mohamed Henidi", correct: true },
      { text: "Mohamed Saad(lemby)", correct: true }
    ]
  }
];
